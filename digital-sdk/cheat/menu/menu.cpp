...
void c_menu::player_esp_tab()
{
	...
	ImGui::Separator();
	ImGui::Checkbox("Enable", &g_cfg.m_esp.m_enable);
	ImGui::Checkbox("Name", &g_cfg.m_esp.m_name);
	ImGui::Checkbox("Health bar", &g_cfg.m_esp.m_healthbar);
	ImGui::Checkbox("Box", &g_cfg.m_esp.m_box);
}
